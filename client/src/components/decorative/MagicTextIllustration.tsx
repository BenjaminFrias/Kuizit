...
export default function MagicTextIllustration() {
	return (
		<div className="w-55 h-70 flex flex-col gap-8 p-8 bg-black/70 rounded-4xl drop-shadow-[13px_11px_8px_rgba(0,0,0,1)] inset-shadow-md inset-shadow-primary/50">
