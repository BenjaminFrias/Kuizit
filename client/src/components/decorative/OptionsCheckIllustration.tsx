...
export default function OptionsCheckIllustration() {
	return (
		<div
			className="w-full h-full flex flex-col justify-between gap-2 p-7 bg-black/60
		rounded-4xl drop-shadow-[13px_11px_8px_rgba(0,0,0,1)] inset-shadow-md inset-shadow-primary/15"
			data-testid="options-check-illustration"
		>
